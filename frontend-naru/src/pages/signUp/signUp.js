    ...
    return (
        <div className="signUp">
            <div className="signUp-wrapper">
                ...
                <Input01 type={"text"} placeholder={"이메일"} size={"m"}/>
                <Input01 type={"text"} placeholder={"인증번호"} size={"m"}/>
                <Button01 text={"인증번호 확인"} size={"m"}/>
                <Input01 type={"text"} placeholder={"닉네임"} size={"m"}/>
                <Input01 type={"password"} placeholder={"비밀번호"} size={"m"}/>
